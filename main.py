...
#===================Python Variables=======================
menu_category = ["Clothes","Footwear","WristWatches","Perfumes","Gadgets","Inners","Others"]

menu_category_dict = {"Clothes":"1 Clothes.txt","Footwear":"2 Footwear.txt",
                "WristWatches":"3 WristWatches.txt","Perfumes":"4 Perfumes.txt",
                "s":"5 Gadgets.txt","Inners":"6 Inners.txt",
                "Others":"7 Others.txt"}
...
root.title("Welcome to FashionHub")
...
menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "black", fg="red", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="black",pady=10)
...
item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "black", fg="red")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="black")
...
item_frame3 = Frame(item_frame, bg="black")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="black", relief=GROOVE)
